...
Route::group(['prefix' => 'admin/settings', 'middleware' => ['xss', 'auth', 'admin', 'FeatureCheck:settings']], function () {
    ...
    Route::post('/firebase-setup',                   [SettingsController::class, 'firebaseSetup'])->name('manage.settings.update.firebase')->middleware('PermissionCheck:firebase_settings_update');
    Route::post('/geocoding-setup',                   [SettingsController::class, 'geocodingSetup'])->name('manage.settings.update.geocoding')->middleware('PermissionCheck:geocoding_settings_update');
    Route::post('/pusher-setup',                   [SettingsController::class, 'pusherSetup'])->name('manage.settings.update.pusher')->middleware('PermissionCheck:pusher_settings_update');
    ...
    Route::post('/contact-info',                   [SettingsController::class, 'contactInfo'])->name('manage.settings.contact-info')->middleware('PermissionCheck:contact_info_settings_update');
    Route::post('/payment-gateway',             [SettingsController::class, 'paymentGateway'])->name('manage.settings.payment-gateway')->middleware('PermissionCheck:payment_gateway_settings_update');
    Route::post('/website-settings',             [SettingsController::class, 'websiteSettings'])->name('manage.settings.website-settings')->middleware('PermissionCheck:website_settings_update');
    //leave setting
