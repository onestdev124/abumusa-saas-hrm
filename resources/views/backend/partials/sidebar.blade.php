                    ...
                    @if (hasFeature('add_ons') &&
                        ...
                        <li class="sidebar-menu-item">
                            <a href="javascript:void(0)"
                                class="parent-item-content has-arrow  {{ menu_active_by_route(['branches.index', 'documents.*', 'documents.types.*', 'break.*']) }}">
                            ...
                            <ul
                                class="child-menu-list  {{ set_active(['documents/*', 'documents/types/*', 'documents/list', 'branches','admin/breaks', 'admin/breaks/*', 'admin/meeting*', 'admin/complain*']) }}">
                                ...
                                @if (isModuleActive('Meeting'))
                                    @include('meeting::sidebar.meeting_sidebar')
                                @endif
                                {{-- End meeting Routes --}}
