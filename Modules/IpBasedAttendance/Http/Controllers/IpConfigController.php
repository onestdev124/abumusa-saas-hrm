...
namespace Modules\IpBasedAttendance\Http\Controllers;

use App\Helpers\CoreApp\Traits\ApiReturnFormatTrait;
use App\Http\Controllers\Controller;
use Brian2694\Toastr\Facades\Toastr;
use Illuminate\Http\Request;
use Modules\IpBasedAttendance\Http\Repositories\IpRepository;
use Modules\IpBasedAttendance\Http\Requests\IPAddressReqeust;
...
class IpConfigController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('ipbasedattendance::ip_setting.index', compact('data'));
        } catch (\Throwable $th) {
    ...
    public function create()
    {
        try {
            ...
            return view('ipbasedattendance::modal.create', compact('data'));
        } catch (\Throwable $th) {
