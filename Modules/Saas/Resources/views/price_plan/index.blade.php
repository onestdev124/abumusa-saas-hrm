                        ...
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries" onchange="pricingPlanDatatable()">
                            ...
                            <div class="align-self-center">
                                @if (hasPermission('pricePlan_create'))
                                <a href="{{ route('saas.pricePlan.create') }}" role="button" class="btn-add"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="pricingPlanDatatable()" autocomplete="off" />
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('active', `{{ route('saas.pricePlan.statusUpdate') }}`)"><span
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" aria-current="true"
                                                onclick="tableAction('inactive',`{{ route('saas.pricePlan.statusUpdate') }}`)">
