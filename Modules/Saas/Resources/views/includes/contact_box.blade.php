...
<div class="contact-form-wrapper">
    ...
    <form action="#" class="contact-form" id="quickContactForm">
        <h5 class="title mb-1">Any Query?</h5>
        <p class="description">Send us a quick message.
        </p>
        <div>
        ...
        <div class="submit-button-wrapper">
            <input class="gradient-btn" id="submitQuery" type="button" value="Send">
        </div>
    </form>
</div>
