    ...
    <div class="card card-primary card-outline">
        ...
        <div class="ltn__tab-menu-list">
            <div class="nav">
                ...
                <a class="show {{menu_active_by_route('employeePresent')}}" href="{{ route('employeeDashboard',encrypt($data['user']->id)) }}">{{_translate('Present')}} <i
                        class="fas fa-home"></i></a>
                <a class="show {{menu_active_by_route('employeeLeave')}}" href="{{ route('employeeDashboard',encrypt($data['user']->id)) }}">{{_translate('Leave')}} <i class="fas fa-home"></i></a>
                <a class="show {{menu_active_by_route('employeeBreaks')}}" href="{{ route('employeeDashboard',encrypt($data['user']->id)) }}">{{_translate('Break')}} <i
                        class="fas fa-home"></i></a>
                <a class="show {{menu_active_by_route('employeeBreaks')}}" href="{{ route('employeeDashboard',encrypt($data['user']->id)) }}">{{_translate('Logout')}} <i
