                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                <ul class="navbar-nav navbar-nav-list ml-auto py-4 py-md-0 align-items-center">
                                    <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                        <a class="nav-link" href="{{currentUrl()}}">Home</a>
                                    </li>
                                    <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    ...
                                    <li class="loginbtn pl-4 pl-md-0 ml-0 ml-md-4">
                                        <a class="login-panel-btn gradient-red-btn" target="_blank" href="https://codecanyon.net/item/honest-hrm/38089948">Buy Now</a>
                                    </li>
