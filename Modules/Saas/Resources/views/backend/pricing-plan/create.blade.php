                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="is_popular" class="form-control select2">
                                            <option></option>
                                            <option value="1" {{ old('is_popular') == 1 ? 'selected' : '' }}>{{ _trans('common.Yes') }}</option>
                                            <option value="0" {{ old('name') && old('is_popular') == 0 ? 'selected' : '' }}>{{ _trans('common.No') }}</option>
                                        </select>
                ...
                <div class="table-content table-basic mb-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="alert alert-warning" id="basicPriceWarning">
                                    ...
                                    <thead>
                                        <tr>
                                            <td colspan="2">
                                                <div class="check-box">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input class="form-check-input cursor-pointer" type="checkbox" id="all_check" onclick="toggleAllFeature(this)" checked>
                                                ...
                                                <td width="30px">
                                                    <div class="check-box">
                                                        <div class="form-check">
                                                            <input class="form-check-input cursor-pointer feature" type="checkbox" name="feature_ids[]" value="{{ $id }}" checked>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>{{ $title }}</td>
