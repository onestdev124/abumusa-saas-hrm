                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="hidden" id="prevName" value="{{ @$pricingPlan->name }}">
                                        <input 
                                            type="text" 
                                            name="name" 
                                                ...
                                                <div class="check-box">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input 
                                                            ...
                                                            "
                                                            {{ 
                                                                @$pricingPlan && in_array($id, @$pricingPlan->pricingPlanPrices->pluck('plan_duration_type_id')->toArray()) 
                                                ...
                                                <div class="check-box">
                                                    <div class="form-check d-flex align-items-center gap-2">
                                                        <input 
                                                            ...
                                                            @if (@$pricingPlan && count(@$pricingPlan->pricingPlanFeatures) == count($planFeatures))
                                                                checked
                                                            @elseif (!@$pricingPlan)
                                                                checked
                                                            @endif
                                                    ...
                                                    <div class="check-box">
                                                        <div class="form-check">
                                                            <input 
                                                                ...
                                                                name="feature_ids[]" 
                                                                value="{{ $id }}" 
                                                                @if (@$pricingPlan && in_array($id, @$pricingPlan->pricingPlanFeatures->pluck('plan_feature_id')->toArray()))
                                                                    checked
                                                                @elseif (!@$pricingPlan)
                                                                    checked
                                                                @endif
...
@section('script')
    <script>
        ...
        const pricingPlanRequired = () => {
            ...
            if (count == 0 && Number($('#basicPrice').val()) == 0) {
                $('#submitBtn').prop('disabled', true);
            } else if (count == 0 && $('#basicPrice').val()) {
