                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_pricing_plan_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                <!-- add btn -->
                                <div class="align-self-center">
                                    <a href="{{ route('saas.pricing-plans.create') }}" role="button" class="btn-add" data-bs-toggle="tooltip"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_pricing_plan_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_pricing_plan_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/pricing-plans";
            data["url"] = url;
            ...
            data["column"] = ["id", "name", "employee_limit", "basic_price", "is_popular", "status", "action"];

            data["table_id"] = "pricing_plan_datatable";
            table(data);
        }
        $(".pricing_plan_datatable").length > 0 ? get_pricing_plan_datatable() : "";
    </script>
@endsection
