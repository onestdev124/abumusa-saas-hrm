                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_subscription_module_category_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                <!-- add btn -->
                                @if (hasPermission('subscription_modules_create'))
                                    <div class="align-self-center">
                                        <a href="{{ route('saas.subscription_module_categories.create') }}" role="button" class="btn-add" data-bs-toggle="tooltip"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_subscription_module_category_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_subscription_module_category_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/module-categories";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "title", "icon", "status", "action"];

            data["table_id"] = "subscription_module_category_datatable";
            table(data);
        }
        $(".subscription_module_category_datatable").length > 0 ? get_subscription_module_category_datatable() : "";
    </script>
@endsection
