                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_subscription_module_values_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('subscription_module_values_create'))
                                    <div class="align-self-center">
                                        <a href="javascript:;" role="button" class="btn-add" data-bs-toggle="tooltip"
                                            onclick="mainModalOpen(`{{ route('saas.subscription_module_values.create_modal') }}`)"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_subscription_module_values_datatable()" autocomplete="off">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('active', `{{ route('saas.subscription_module_values.statusUpdate') }}`)"><span
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" aria-current="true"
                                                onclick="tableAction('inactive',`{{ route('saas.subscription_module_values.statusUpdate') }}`)">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('delete', `{{ route('saas.subscription_module_values.delete_data') }}`)">
...
@section('script')
    ...
    <script>
        function get_subscription_module_values_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/module-terms";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "title", "category_id", "status", "action"];
            data["table_id"] = "subscription_module_values_table";
            table(data);
        }
        $(".subscription_module_values_table").length > 0 ? get_subscription_module_values_datatable() : "";
    </script>
@endsection
