                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_subscription_packages_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_subscription_packages_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/packages";
            data["url"] = url;
            ...
            data["column"] = ["id", "name", "description", "image", "price", "period", "term_wise_price", "currency_id", "product_id", "status", "action"];

            data["table_id"] = "subscription_packages_datatable";
            table(data);
        }
        $(".subscription_packages_datatable").length > 0 ? get_subscription_packages_datatable() : "";
    </script>
@endsection
