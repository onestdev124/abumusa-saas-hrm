                        ...
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_subscription_purchased_packages_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('designation_create'))
                                    <div class="align-self-center">
                                        <a href="{{ route('saas.subscription_purchased_packages.create') }}" role="button" class="btn-add" data-bs-toggle="tooltip"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_subscription_purchased_packages_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_subscription_purchased_packages_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/purchased-packages";
            data["url"] = url;
            ...
            data["column"] = ["id", "user_id", "package_plan_id", "payment_method_id", "currency_id", "invoice_no", "purchase_date", "activated_date", "expired_date","subscription_payment_details", "payment_status", "is_trial","status", "action"];

            data["table_id"] = "subscription_purchased_packages_datatable";
            table(data);
        }
        $(".subscription_purchased_packages_datatable").length > 0 ? get_subscription_purchased_packages_datatable() : "";
    </script>
@endsection
