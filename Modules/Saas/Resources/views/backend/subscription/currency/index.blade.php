                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('subscription_currency_create'))
                                    <div class="align-self-center">
                                        <a href="javascript:;" role="button" class="btn-add" data-bs-toggle="tooltip"
                                            onclick="mainModalOpen(`{{ route('saas.subscription_currencies.create_modal') }}`)"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_subscription_currency_datatable()" autocomplete="off">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('active', `{{ route('saas.subscription_currencies.statusUpdate') }}`)"><span
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" aria-current="true"
                                                onclick="tableAction('inactive',`{{ route('saas.subscription_currencies.statusUpdate') }}`)">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('delete', `{{ route('saas.subscription_currencies.delete_data') }}`)">
...
@section('script')
    ...
    <script>
        function get_subscription_currency_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/currencies";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "title", "code", "symbol", "exchange_rate", "position", "precision", "status", "action"];
            data["table_id"] = "subscription_currency_table";
            table(data);
        }
        $(".subscription_currency_table").length > 0 ? get_subscription_currency_datatable() : "";
    </script>
@endsection
