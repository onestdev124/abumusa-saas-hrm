                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_email_template_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                <!-- add btn -->
                                {{-- <div class="align-self-center">
                                    <a href="{{ route('saas.email-template.create') }}" role="button" class="btn-add" data-bs-toggle="tooltip"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_email_template_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_email_template_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/email-template";
            data["url"] = url;
            ...
            data["column"] = ["id", "title", "subject", "status", "action"];

            data["table_id"] = "email_template_datatable";
            table(data);
        }
        $(".email_template_datatable").length > 0 ? get_email_template_datatable() : "";
    </script>
@endsection
