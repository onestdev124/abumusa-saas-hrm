                                ...
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea type="text" name="content" placeholder="{{ _trans('common.Enter Content') }}"
                                            class="form-control content ot-form-control" required>{{ $template->content }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="status_id" class="form-control select2">
                                            <option value="1" {{ $template->status_id == 1 ? 'selected' : '' }}>{{ _trans('common.Active') }}</option>
                                            <option value="4" {{ $template->status_id == 4 ? 'selected' : '' }}>{{ _trans('common.Inactive') }}</option>
                                        </select>
