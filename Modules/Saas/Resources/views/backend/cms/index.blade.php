                        ...
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('designation_create'))
                                    <div class="align-self-center">
                                        <a href="{{ route('saas.cms.create') }}" role="button" class="btn-add" data-bs-toggle="tooltip"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_cms_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_cms_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/admin/saas/cms";
            data["url"] = url;
            ...
            data["column"] = ["id", "title", "image", "description", "text_color","bg_color","order", "status", "action"];

            data["table_id"] = "cms_datatable";
            table(data);
        }
        $(".cms_datatable").length > 0 ? get_cms_datatable() : "";
    </script>
@endsection
