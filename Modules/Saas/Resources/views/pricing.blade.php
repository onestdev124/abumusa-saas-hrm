        ...
        <div class="row">
            <div class="top-content col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
                <div class="section-title">
                    ...
                    <p>We invite you to take a self guided tour through the pihr experience. Stop, start, and review at
                        our own pace. When you’re ready for more just schedule a demo to take a look at HR software and
                        have experience with the best HRM software in Bangladesh.</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-3 col-xl-3 col-md-6 col-sm-6 col-12">
                <div class="single-pricing mb-5 rounded  shadow">
                    ...
                    <div>
                        ...
                        <h2 class="text-center"> <sup class="pricing-sup"></sup>{{ @$pricing['price'] }}$<sub
                                class="pricing-sub">/Month</sub></h2>
                        @else
                        <h2 class="text-center"> <sup class="pricing-sup"></sup>{{ @$pricing['price'] }}$<sub
                                class="pricing-sub">/Per User</sub></h2>
                        @endif
                        <h2 class="text-center"> <sub class="pricing-sub text-danger">{{ @$pricing['subscription']
                                }}</sub></h2>
                    </div>
                    <div class="pricing-body">
                        <ul class="list-none">
                            ...
                            <li class="pricing-li"><span class="align-middle pricing-list"><i
                                        class="bi bi-check"></i></span><span class="text-bold text-info text-uppercase">
                                    {{ $key }}</span> -
                                {{ $feature }}</li>
                            @endforeach
                        </ul>
                    ...
                    <div class="pricing-footer text-center my-4">
                        <a href="{{ route('saas.contact') }}"
                            class="btn px-3 {{ @$pricing['class'] }} rounded shadow pricing-button">Contact Us</a>
                    </div>
                </div>
            </div>
            @endforeach
