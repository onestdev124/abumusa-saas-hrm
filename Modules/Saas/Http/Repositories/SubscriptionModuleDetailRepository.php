...
class SubscriptionModuleDetailRepository extends SubscriptionBaseRepository  implements SubscriptionModuleDetailInterface
{
    protected $model;

    /**
     * SubscriptionModuleDetailRepository constructor.
     *
     * @param SubscriptionModuleDetails $model The model instance to be used.
     */
    public function __construct(SubscriptionModuleDetails $model)
    {
        $this->model = $model;
    }
