...
class SubscriptionPackagePlanRepository extends SubscriptionBaseRepository  implements SubscriptionPackagePlanInterface
{
    protected $model;
     ...
     *
     * @param SubscriptionPackagePlan $model The model instance to be used.
     */
