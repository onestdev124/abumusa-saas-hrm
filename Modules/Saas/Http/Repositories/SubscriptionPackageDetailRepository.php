...
use Modules\Saas\Entities\SubscriptionPackageDetails;
use Modules\Saas\Http\Interfaces\SubscriptionPackageDetailInterface;

class SubscriptionPackageDetailRepository extends SubscriptionBaseRepository  implements SubscriptionPackageDetailInterface
{
    protected $model;
     ...
     *
     * @param SubscriptionPackageDetails $model The model instance to be used.
     */
    public function __construct(SubscriptionPackageDetails $model)
    {
        $this->model = $model;
    }
