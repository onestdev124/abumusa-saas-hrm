   ...
   /**
    ...
    public function messages()
    {
        return [
            ...
            'email.unique' => _trans('validation.Email should be unique'),
            'phone.required' => _trans('validation.Phone is required'),
            'phone.unique' => _trans('validation.Phone should be unique'),
