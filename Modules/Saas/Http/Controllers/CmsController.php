...
class CmsController extends Controller
{
    ...
    public function __construct(CmsRepository $modelRepository)
    {
        $this->modelRepository = $modelRepository;
        $this->title = _trans('saas.Cms');
        $this->viwPath = "saas::backend.cms.index";
        $this->createPath = "saas::backend.cms.module.create";
        $this->createModalPath = "saas::backend.modal.create";
        $this->createFormPath = "saas::backend.form.create";
        $this->editPath = "saas::backend.cms.module.edit";
        $this->className = "cms_datatable";
    }
    ...
    public function edit($id)
    {
        ...
        try {
            return view($this->createFormPath, [
                ...
                'items' => $module,
                'url' => route('saas.cms.update', $module->id),
