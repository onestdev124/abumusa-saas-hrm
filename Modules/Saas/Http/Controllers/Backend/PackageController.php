...
class PackageController extends Controller
{
    ...
    public function __construct(SubscriptionPackageRepositoryInterface $modelRepository)
    {
        $this->modelRepository = $modelRepository;
        $this->title = _trans('subscription.Subscription Package');
        $this->viwPath = "saas::backend.subscription.packages.index";
        ...
        $this->className = "subscription_packages_datatable";
    }
