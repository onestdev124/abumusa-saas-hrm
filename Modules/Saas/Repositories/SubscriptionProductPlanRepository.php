...
class SubscriptionProductPlanRepository implements SubscriptionProductPlanRepositoryInterface
{
        ...
        return [
            'data' => $data->map(function ($data) {
                ...
                return [
                    ...
                    'price' => @$data->price,
                    'is_trial' => @$data->is_trial ? '<span class="badge badge-success">Yes</span>' : '<span class="badge badge-danger">No</span>',
                    'is_featured' => @$data->is_featured ? '<span class="badge badge-success">Yes</span>' : '<span class="badge badge-danger">No</span>',
